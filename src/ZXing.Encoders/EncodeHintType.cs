...
namespace ZXing.Encoders
{
    ...
    public enum EncodeHintType
    {
        ...
        /// <see cref="ZXing.Encoders.QrCode.ErrorCorrectionLevel" />
        ...
        /// For PDF417 it is of type <see cref="ZXing.Encoders.PDF417.PDF417ErrorCorrectionLevel"/> or <see cref="int" /> (between 0 and 8),
        /// </summary>
        ERROR_CORRECTION,
        ...
        /// type: <see cref="ZXing.Encoders.PDF417.PDF417AspectRatio" />, or 1-4.
        /// </summary>
        PDF417_ASPECT_RATIO,
        ...
        /// type: <see cref="ZXing.Encoders.PDF417.Compaction" /> or <see cref="string" /> value of one of its
        /// enum values
        /// </summary>
        PDF417_COMPACTION,
        ...
        /// type: <see cref="ZXing.Encoders.PDF417.Dimensions" />
        /// </summary>
        PDF417_DIMENSIONS,
        ...
        /// <summary>
        /// Specifies the matrix shape for Data Matrix (type <see cref="ZXing.Encoders.Datamatrix.Encoder.SymbolShapeHint"/>)
        /// </summary>
        DATA_MATRIX_SHAPE,

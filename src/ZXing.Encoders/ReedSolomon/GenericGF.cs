...
namespace ZXing.Encoders.ReedSolomon
{
    ...
    ///   <p>Throughout this package, elements of the GF are represented as an <see cref="int"/>
    ...
    public sealed class GenericGF
    {
        ...
        static internal int AddOrSubtract(int a, int b) => a ^ b;
        ...
        /// <exception cref="ArgumentException"></exception>
        internal int Log(int a) => (a == 0) ? throw new ArgumentException() : logTable[a];
        ...
        internal int Inverse(int a) => (a == 0) ? throw new ArithmeticException() : expTable[Size - logTable[a] - 1];

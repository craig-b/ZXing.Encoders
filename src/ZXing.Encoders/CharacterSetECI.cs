...
namespace ZXing.Encoders
{
    ...
    public sealed class CharacterSetECI : ECI
    {
        ...
        private CharacterSetECI(int value, string encodingName) : base(value) => EncodingName = encodingName;
        ...
        private static void AddCharacterSet(int value, string[] encodingNames)
        {
            ...
            VALUE_TO_ECI[value] = eci; // can't use valueOf
            foreach (var t in encodingNames)
            {
                NAME_TO_ECI[t] = eci;
            }
        }
        ...
        public static CharacterSetECI GetCharacterSetECIByName(string name) => NAME_TO_ECI[name.ToUpper()];
    }
}
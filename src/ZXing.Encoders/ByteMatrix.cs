...
namespace ZXing.Encoders
{
    ...
    public sealed class ByteMatrix
    {
        ...
        public void Set(int x, int y, byte value) => Array[y][x] = value;
        ...
        public void Set(int x, int y, bool value) => Array[y][x] = (byte)(value ? 1 : 0);
        ...
        {
            var result = new StringBuilder(((2 * Width) + 1) * Height);
            for (int y = 0; y < Height; ++y)
            {
                var bytesY = Array[y];
                for (int x = 0; x < Width; ++x)

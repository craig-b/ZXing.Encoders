...
namespace ZXing.Encoders
{
    ...
    public sealed class BitArray
    {
        ...
        /// </param>
        public void Flip(int i) => Array[i >> 5] ^= 1 << (i & 0x1F);
        ...
        /// </param>
        public void SetBulk(int i, int newBits) => Array[i >> 5] = newBits;
        ...
        /// </returns>
        public object Clone() => new BitArray((int[])Array.Clone(), Size);
    }
}